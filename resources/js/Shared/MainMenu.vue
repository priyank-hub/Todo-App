  ...
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/organizations">
        <i class="fa-solid fa-money-check-dollar mr-2 w-4 h-4" :class="isUrl('organizations') ? 'text-white' : 'text-indigo-400 group-hover:fill-white'"></i>
        <div :class="isUrl('organizations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Expenses</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/contacts">
        <i class="fa-solid fa-chart-line mr-2 w-4 h-4" :class="isUrl('organizations') ? 'text-white' : 'text-indigo-400 group-hover:fill-white'"></i>
        <!-- <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('contacts') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" /> -->
        <div :class="isUrl('contacts') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Analytics</div>
      </Link>
    </div>
    <!-- <div class="mb-4">
